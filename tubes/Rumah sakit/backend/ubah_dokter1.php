  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <div class="col-md-10 pt-5">
        ...
        <a href= "daftar_dokter_pengguna.php" class="btn badge btn-danger"><i class="fa-solid fa-circle-left"></i> Kembali ke Daftar Dokter</a>
        ...
        <button type="submit" class="btn btn-danger" name="ubah_dokter"><i class="fa-solid fa-pen-to-square"></i> Ubah Data Dokter</button>
        </form>
      </div>
    </div>
