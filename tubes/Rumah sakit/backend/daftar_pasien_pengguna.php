  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <div class="col-md-10 pt-5">
        ...
        <a href= "tambah_data_pasien1.php" class="btn badge btn-danger "><i class="fa-solid fa-plus"></i> Tambah Data Pasien</a>
  <div id="container">
        <table class="table">
          <thead>
            <tr>
          ...
          <tbody>
            ...
            <?php  foreach ($tbl_pasien as $tbl_p) { ?>
              <tr>
                ...
                <td>
                  <a href="ubah_pasien1.php?id=<?= $tbl_p['id_pasien'] ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                  <a href="hapus_pasien1.php?id=<?= $tbl_p['id_pasien'] ?>" onclick = "return confirm('yakin ingin menghapus data?');"><i class="fa-solid fa-trash-can"></i></a>
                </td>
              </tr>
            <?php  } ?>
          </tbody>
