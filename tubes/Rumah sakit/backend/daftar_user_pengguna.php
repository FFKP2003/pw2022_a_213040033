          ...
          <tbody>
            ...
            <?php  foreach ($tbl_user as $tbl_u) { ?>
              <tr>
                ...
                <td>
                  <a href="ubah_user1.php?id=<?= $tbl_u['id_user'] ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                  <a href="hapus_user1.php?id=<?= $tbl_u['id_user'] ?>" onclick = "return confirm('yakin ingin menghapus data?');"><i class="fa-solid fa-trash-can"></i></a>
                </td>
              </tr>
            <?php  } ?>
          </tbody>
