...
<html lang="en">
  ...
  <body>
      ...
      <a href="index.php" class="btn badge btn-info">kembali ke Daftar Mahasiswa</a>
      <div class="rows mt-3">
          <div class="col-5">
              <form action="" method="post" autocomplete = "off">
                ...
                <input type="hidden" name="id" value="<?= $mhs['id']; ?>">
                  <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="npm" name="npm"require maxlength = "9" minlength="9" style= "width:150px;" value="<?= $mhs["npm"]; ?>"> 
                  </div>
